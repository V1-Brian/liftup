...
- **Amazon return notifications** — from Amazon (`@amazon.com`). Subject contains "refund" or "return" and includes Amazon Order ID (`XXX-XXXXXXX-XXXXXXX`). Creates a `pending_returns` row for user review.
